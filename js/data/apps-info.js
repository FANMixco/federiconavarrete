      ...
      edition: [
          {
            ...
            },
            {
               ...
               technologies: [
                  "mdi mdi-windows", "mdi mdi-language-csharp", [{type: "icon", id: "id_xaml", icon: "mdi mdi-language-xaml", tooltip: "XAML"}], "fab fa-html5", "fab fa-css3-alt", "fab fa-js-square", "mdi mdi-jquery", "fab fa-git", [{type: "icon", id: "id_bitbucket", icon: "mdi mdi-bitbucket", tooltip: "Bitbucket"}], [{type: "img", id: "id_ads", text: "Ads", icon: "ad.svg"}]
               ],
               order: 1
            },
            {
               ...
               technologies: [
                  "mdi mdi-windows", "mdi mdi-language-csharp", [{type: "icon", id: "id_xaml", icon: "mdi mdi-language-xaml", tooltip: "XAML"}], "fab fa-git", [{type: "icon", id: "id_bitbucket", icon: "mdi mdi-bitbucket", tooltip: "Bitbucket"}], [{type: "img", id: "id_ads", text: "Ads", icon: "ad.svg"}]
               ],
               order: 1
            }
      ]
      ...
      edition: [
            {
               ...
               technologies: [
                  "mdi mdi-windows", "mdi mdi-cordova", "fab fa-html5", "fab fa-css3-alt", "fab fa-js-square", "mdi mdi-jquery", [{type: "icon", id: "id_json", icon: "mdi mdi-code-json", tooltip: "JSON/Web Service"}], "mdi mdi-microsoft-azure", [{ type:"mix-left-icon", id: "id_mysql", text: "<sub>MySQL</sub>", icon: "fas fa-database"}], "mdi mdi-language-php", "mdi mdi-google-maps", "mdi mdi-crosshairs-gps", "fab fa-git", [{type: "icon", id: "id_bitbucket", icon: "mdi mdi-bitbucket", tooltip: "Bitbucket"}]
               ],
               order: 4
            }
         ]
