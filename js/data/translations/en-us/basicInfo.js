const basicInfo = {
	...
	"aboutDesc": [
		...
		`Furthermore, I'm on the constant quest of the next <i>great thing</i>! Plus, challenges define me. I love innovation contests like Microsoft Imagine Cup and create a better world.
                  ...
                  <p class="lead text-uppercase text-warning carousel-video-inner font-weight-bold"><i>What about you? Are you ready for your next challenge? <a id="linkContactMeAbout" class="text-danger">We can work on it together.</a></i>`
	],
	"favApp": {
